...
from nets import BN_r_double_conv
...
class Conditional_UNet(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.dconv_down1 = BN_r_double_conv(3, 64)
        self.dconv_down2 = BN_r_double_conv(64, 128)
        self.dconv_down3 = BN_r_double_conv(128, 256)
        self.dconv_down4 = BN_r_double_conv(256, 512)
        ...
        self.dconv_up3 = BN_r_double_conv(256 + 512, 256)
        self.dconv_up2 = BN_r_double_conv(128 + 256, 128)
        self.dconv_up1 = BN_r_double_conv(64 + 128, 64)
